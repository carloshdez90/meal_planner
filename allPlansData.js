...
const allPlansData = {
    "octubre2024": {
        ...
        data: {
            ...
            meriendasAM: [
                { name: "Opción 1 AM", type: "am", items: ["1 rebanada de pan integral + 15 gr de aguacate"], calories: "No disponible" },
                { name: "Opción 2 AM", type: "am", items: ["2 galletas de arroz + 1 guineo pequeño"], calories: "No disponible" },
                { name: "Opción 3 AM", type: "am", items: ["10 almendras + 1 taza de fruta"], calories: "No disponible" }
            ],
            meriendasPM: [
                { name: "Opción 1 PM", type: "pm", items: ["1 taza de fruta variada"], calories: "No disponible" },
                { name: "Opción 2 PM", type: "pm", items: ["1 cda de mantequilla de maní Tosh + 1 rebanada de pan integral"], calories: "No disponible" },
                { name: "Opción 3 PM", type: "pm", items: ["1 taza de pepino con limón y sal"], calories: "No disponible" },
                { name: "Opción 4 PM", type: "pm", items: ["1 taza de gelatina light + 1/2 taza de fruta"], calories: "No disponible" },
                { name: "Opción 5 PM", type: "pm", items: ["4 galletas de arroz con mermelada light"], calories: "No disponible" }
            ]
        }
    },
    "noviembre2024": {
        ...
        data: { 
            ...
            meriendasPM: [
                { name: "Opción 1 PM", type: "pm", items: ["1 taza de fruta variada"], calories: "No disponible" },
                { name: "Opción 2 PM", type: "pm", items: ["1 cucharada de mantequilla de maní Tosh + 1 rebanada de pan integral"], calories: "No disponible" },
                { name: "Opción 3 PM", type: "pm", items: ["1 manzana con limón y sal"], calories: "No disponible" },
                { name: "Opción 4 PM", type: "pm", items: ["1 taza de gelatina light + 1/2 taza de fruta"], calories: "No disponible" },
                { name: "Opción 5 PM", type: "pm", items: ["4 galletas de arroz con mermelada light"], calories: "No disponible" }
            ]
        }
    ...
    "febrero2025": {
        ...
        data: { 
            ...
            meriendas: [ 
                { name: "Merienda AM", type: "am", items: ["1 scoop de whey protein + 1 taza de leche de almendras"], calories: "No disponible" },
                { name: "Merienda PM", type: "pm", items: ["1 yogurt Dos Pinos Protein Plus"], calories: "No disponible" }
            ]
        }
    },
    "meriendasFitAdicionales": { 
        ...
        items: [
            { name: "Opción 1", type: "all", items: ["1 yogurt griego Dos Pinos Plus + 2 cucharadas de arándanos"], calories: "No disponible" },
            { name: "Opción 2", type: "all", items: ["Enrollados de jamón de pavo con queso cottage (2 lascas de jamón de pavo con 1 cada. De queso cottage cada uno, acompañar con pepino y tomate)"], calories: "No disponible" },
            { name: "Opción 3", type: "all", items: ["Batido de proteína con avena y cacao: 1 scoop de whey protein + 1/3 taza de avena + 1 cucharadita de cacao"], calories: "No disponible" },
            { name: "Opción 4", type: "all", items: ["1 barrita de proteína Quest (GNC)"], calories: "No disponible" },
            { name: "Opción 5", type: "all", items: ["Manzana con mantequilla de maní (1 manzana pequeña + 1 cucharada de mantequilla de maní)"], calories: "No disponible" }
        ]
    }
};
